...
key_board = np.zeros((300,500,3),np.uint8)
...
def draw_letters(letter_index, text, letter_light):
    ...
    if letter_light is True:
        cv2.rectangle(key_board, (x + th, y + th), (x + width - th, y + height - th), (255, 255, 255), -1)
        cv2.putText(key_board, text, (text_x, text_y), font_letter, font_scale, (51, 51, 51), font_th)
    else:
        cv2.rectangle(key_board, (x + th, y + th), (x + width - th, y + height - th), (51, 51, 51), -1)
        cv2.putText(key_board, text, (text_x, text_y), font_letter, font_scale, (255, 255, 255), font_th)

def draw_menu():
    rows, cols, _ = key_board.shape
    th_lines = 2 # thickness lines
    cv2.line(key_board, (int(cols/2) - int(th_lines/2), 0),(int(cols/2) - int(th_lines/2), rows),
             (51, 51, 51), th_lines)
    cv2.putText(key_board, "LEFT", (40, 150), font, 3, (255, 255, 255), 3)
    cv2.putText(key_board, "RIGHT", (40 + int(cols/2), 150), font, 3, (255, 255, 255), 3)
...
while True:
   ...
   # Show the text we're writing on the board
    cv2.putText(board, text, (5, 70), font, 3, 0, 2)
    ...
    cv2.imshow("Virtual keyboard", key_board)
